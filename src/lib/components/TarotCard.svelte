...
<button class="w-64 h-96 perspective-1000 cursor-pointer" on:click={flipCard}>
	...
	>
		<!-- Back of the card -->
		<div
			class="absolute w-full h-full backface-hidden bg-cover bg-center rounded-lg shadow-xl"
			style="background-image: url({backImage});"
		></div>

		<!-- Front of the card -->
		<div
			class="absolute w-full h-full backface-hidden bg-white rounded-lg shadow-xl rotate-y-180 overflow-hidden flex flex-col"
		>
